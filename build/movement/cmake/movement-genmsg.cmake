...
set(MSG_I_FLAGS "-Imovement:/home/dtrobot/DetectRobot/src/movement/msg")
...
get_filename_component(_filename "/home/dtrobot/DetectRobot/src/movement/msg/wheelVelocity.msg" NAME_WE)
add_custom_target(_movement_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "movement" "/home/dtrobot/DetectRobot/src/movement/msg/wheelVelocity.msg" ""
)
...
_generate_msg_cpp(movement
  "/home/dtrobot/DetectRobot/src/movement/msg/wheelVelocity.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/movement)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/movement\")")
  # install generated code
  install(
